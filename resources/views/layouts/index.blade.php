...
<head>
    ...
    <!-- Bootstrap -->
    <link type="text/css" rel="stylesheet" href="{{asset('themes/css/bootstrap.min.css')}}"/>

    <!-- Slick -->
    <link type="text/css" rel="stylesheet" href="{{asset('themes/css/slick.css')}}"/>
    <link type="text/css" rel="stylesheet" href="{{asset('themes/css/slick-theme.css')}}"/>

    <!-- nouislider -->
    <link type="text/css" rel="stylesheet" href="{{asset('themes/css/nouislider.min.css')}}"/>

    <!-- Font Awesome Icon -->
    <link rel="stylesheet" href="{{asset('themes/css/font-awesome.min.css')}}">

    <!-- Custom stlylesheet -->
    <link type="text/css" rel="stylesheet" href="{{asset('themes/css/style.css')}}"/>
